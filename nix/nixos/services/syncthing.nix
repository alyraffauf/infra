{
  ...
  options.myNixOs.service.syncthing = {
    ...
    romsPath = lib.mkOption {
      default = "/home/${config.myNixOs.service.syncthing.user}/roms";
  ...
  config = lib.mkIf config.myNixOs.service.syncthing.enable {
    ...
    services = {
      ...
      syncthing = let
        cfg = config.myNixOs.service.syncthing;
