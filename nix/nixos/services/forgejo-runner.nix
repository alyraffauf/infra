{
  ...
  options.myNixOs.service.forgejoRunner = {
  ...
  config = lib.mkIf config.myNixOs.service.forgejoRunner.enable {
    assertions = [
      {
      ...
      in {
        alycodes-containers = {
          ...
          settings = {
            ...
            runner.capacity = config.myNixOs.service.forgejoRunner.dockerContainers;
          };
        ...
        alycodes-nixos = {
          ...
          settings = {
            container.network = "host";
            runner.capacity = config.myNixOs.service.forgejoRunner.nativeRunners;
          };
